<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterSPA.aspx.cs" Inherits="MileStone_3.RegisterSPA" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Register SPA</title>
<meta charset="UTF-8"/>
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/spa.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					Register As a Sports Association Manager
				</span>
