<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterCR.aspx.cs" Inherits="MileStone_3.RegisterCR" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Register CR</title>
<meta charset="UTF-8"/>
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/cr.jpeg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					Register As a Club Representative
				</span>
				...
				<form  id="form1" runat="server" class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="wrap-input100-2">
                        <asp:DropDownList ID="clubname" class="input100-2" runat="server" required="True" >
						<asp:ListItem Value="Choose Club" hidden="True"></asp:ListItem>
                        </asp:DropDownList>
